...
export default function Hero() {
  return (
    <section className="relative bg-[#00263C] pt-16 pb-32 md:pb-40 px-6 md:px-12 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
        ...
        <div className="md:w-1/2 w-full relative">
          <div className="relative">
            ...
            <div className="absolute -top-4 left-6 w-9 h-9 rounded-full bg-[#00263C] shadow-lg flex items-center justify-center">
            ...
            <div className="absolute -bottom-6 -left-4 bg-white rounded-xl shadow-xl px-4 py-3 flex items-center gap-3">
              <div>
                ...
                <p className="text-lg font-bold text-[#00263C]">2,409</p>
              </div>
            ...
            <div className="absolute -bottom-8 right-2 bg-white rounded-xl shadow-xl px-4 py-3 flex items-center gap-3">
              <svg className="w-8 h-8 text-[#00263C]" viewBox="0 0 36 24" fill="none">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-[#00263C]">6,208</p>
              </div>
            </div>
          </div>
        </div>
