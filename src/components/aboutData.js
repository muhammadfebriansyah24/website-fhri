    ...
    return {
      ...
      leadershipTeam: [
        ...
        { 
          ...
          summary: [
            "Rumbi Simatupang adalah seorang profesional dengan pengalaman lebih dari 30 tahun di bidang Executive Office Management, Corporate Governance, dan Corporate Administration, termasuk lebih dari 25 tahun mendukung jajaran eksekutif tingkat C (C-Level) di berbagai perusahaan terkemuka di Indonesia. Dengan integritas tinggi, kemampuan komunikasi yang kuat, serta pemahaman yang mendalam mengenai tata kelola perusahaan, ia memiliki rekam jejak yang solid dalam mendukung pengambilan keputusan strategis, meningkatkan efektivitas organisasi, serta memastikan kelancaran operasional dan penerapan tata kelola perusahaan yang baik. Dikenal sebagai sosok yang profesional, adaptif, dan berorientasi pada hasil, Rumbi mampu mengelola berbagai prioritas, membangun sinergi lintas fungsi, serta menjalin hubungan yang efektif dengan berbagai pemangku kepentingan.",
            "Selain pengalaman panjang di dunia korporasi, Rumbi juga pernah berkolaborasi dengan dua mitra dalam mengembangkan dan mengelola bisnis Virtual Assistant, yang memperluas perspektifnya terhadap kebutuhan bisnis serta pemberian layanan profesional yang responsif, efisien, dan berorientasi pada pelanggan. Pengalaman tersebut semakin memperkaya wawasan kewirausahaan dan memperkuat kemampuannya dalam mengembangkan solusi kerja yang inovatif, mengoptimalkan pemanfaatan teknologi digital, serta menciptakan nilai tambah bagi organisasi melalui pendekatan yang strategis, kolaboratif, dan berorientasi pada hasil."
          ]
        },
        { 
  ...
  return {
    ...
    leadershipTeam: [
      ...
      { 
        ...
        image: '/images/profile_indriany.jpg',
        summary: [
          "Rumbi Simatupang is a seasoned professional with more than 30 years of experience in Executive Office Management, Corporate Governance, and Corporate Administration, including over 25 years of providing trusted support to C-level executives across leading organizations in Indonesia. Recognized for her integrity, strong communication skills, and in-depth understanding of corporate governance, she has a proven track record of supporting strategic decision-making, enhancing organizational effectiveness, and ensuring operational excellence and sound governance at the executive level. Known for her professionalism, adaptability, and results-oriented approach, Rumbi excels at managing multiple priorities, fostering cross-functional collaboration, and building strong relationships with key stakeholders.",
          "Complementing her extensive corporate career, Rumbi previously co-founded and managed a Virtual Assistant business with two partners, an entrepreneurial venture that broadened her perspective in delivering responsive, efficient, and client-focused professional services. This experience further strengthened her ability to develop innovative business solutions, leverage digital technologies to enhance operational efficiency, and create sustainable value for organizations. With a unique combination of executive support expertise and entrepreneurial experience, she brings a strategic, collaborative, and results-driven approach to helping organizations achieve their business objectives."
        ]
      },
      { 
        name: 'Julianto Bona Pardamean', 
