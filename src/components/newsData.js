export const getNewsData = (locale) => {
  if (locale === 'id') {
    return [
      { 
        ...
        title: 'QUIET QUITTING BUKAN SALAH KARYAWAN.', 
        description: 'Ini Alarm Keras Bagi Kepemimpinan. Setiap kali mendengar istilah quiet quitting, banyak pemimpin langsung mengambil kesimpulan: "Karyawan sekarang kurang loyal." "Mentalnya lemah." "Maunya work-life balance, tapi tidak mau kerja keras." Benarkah demikian?.',
        publishedAt: '03 Agustus 2026 • 15:00 WIB',
        content: `
          <p style="text-align: justify;">Ini Alarm Keras Bagi Kepemimpinan. Setiap kali mendengar istilah quiet quitting, banyak pemimpin langsung mengambil kesimpulan: "Karyawan sekarang kurang loyal."
      ...
      { 
        ...
        content: `
          <p style="text-align: justify;">First HR Indonesia dengan bangga mengumumkan peluncuran modul sertifikasi terbaru kami yang dirancang khusus untuk profesional HR tingkat menengah. Program ini dibuat untuk menjembatani kesenjangan keterampilan dalam menghadapi tantangan manajemen talenta modern.</p>
          <br/>
      ...
      { 
        ...
        content: `
          <p style="text-align: justify;">Berdasarkan laporan riset terbaru yang dirilis oleh tim riset internal FHRI, model kerja hybrid kini telah bergeser dari sekadar tren sementara menjadi standar operasional jangka panjang bagi sebagian besar perusahaan multinasional.</p>
          <br/>
      ...
      { 
        ...
        content: `
          <p style="text-align: justify;">Dalam upaya berkelanjutan untuk menyediakan standar pendidikan sumber daya manusia kelas dunia, First HR Indonesia telah secara resmi menandatangani nota kesepahaman (MoU) strategis dengan tiga universitas terkemuka di tanah air.</p>
          <br/>
  ...
  return [
    { 
      ...
      content: `
        <p style="text-align: justify;">This is a Loud Alarm for Leadership. Every time they hear the term quiet quitting, many leaders immediately conclude: "Employees today are less loyal."
    ...
    { 
      ...
      publishedAt: '18 August 2026 • 13:30 WIB',
      content: `
        <p style="text-align: justify;">First HR Indonesia proudly announces the launch of our newest certification module specifically designed for mid-level HR professionals. This program was created to bridge the skills gap in facing modern talent management challenges.</p>
        <br/>
    ...
    { 
      ...
      description: 'Research findings regarding hybrid work models and employee engagement in 2026.',
      publishedAt: '24 August 2026 • 10:15 WIB',
      content: `
        <p style="text-align: justify;">Based on the latest research report released by the FHRI internal research team, the hybrid work model has now shifted from just a temporary trend to a long-term operational standard for most multinational companies.</p>
        <br/>
    ...
    { 
      ...
      description: 'FHRI collaborates with leading universities to expand learning modules.',
      publishedAt: '30 August 2026 • 15:45 WIB',
      content: `
        <p style="text-align: justify;">In a continuous effort to provide world-class human resource education standards, First HR Indonesia has officially signed a strategic memorandum of understanding (MoU) with three leading universities in the country.</p>
        <br/>
