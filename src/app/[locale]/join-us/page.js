      ...
      <div className="relative z-10 max-w-6xl w-full grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div className="flex flex-col text-left">
          <h1 className="text-white mb-6">
            {data.hero.title1} <br />
            {data.hero.title2} <br />
            {locale === 'id' ? 'Bersama' : 'With'} <span className="text-brand-red">First HR Indonesia</span>
          </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full border border-slate-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-brand-navy focus:ring-1 focus:ring-brand-navy transition-colors placeholder:text-slate-400 text-slate-800"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full border border-slate-300 rounded-lg px-4 py-2.5 text-sm appearance-none bg-white focus:outline-none focus:border-brand-navy focus:ring-1 focus:ring-brand-navy transition-colors text-slate-800 cursor-pointer"
                  >
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full bg-brand-red hover:bg-red-700 text-white font-bold text-sm py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-md cursor-pointer"
                >
                  {data.form.submitBtn}
                  <div 
